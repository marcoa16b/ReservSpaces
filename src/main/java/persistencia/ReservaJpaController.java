...
public class ReservaJpaController implements Serializable {
    ...
    public ReservaJpaController() {
        this.emf = Persistence.createEntityManagerFactory("ReservaEspaciosPU"); //Persistence.createEntityManagerFactory("Reserva_EspaciosPU");
    }
    ...
    public void create(Reserva reserva) {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                System.out.println("Error al intentar crear la reserva...");
            }
            throw ex;
        } finally {
            if (em != null) {
